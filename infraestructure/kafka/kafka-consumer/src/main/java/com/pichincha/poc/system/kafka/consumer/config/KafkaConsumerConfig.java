package com.pichincha.poc.system.kafka.consumer.config;

import com.pichincha.poc.system.kafka.config.data.KafkaConfigData;
import com.pichincha.poc.system.kafka.config.data.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig <K extends Serializable, V extends SpecificRecordBase> {
    ...
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<K, V>> kafkaListenerContainerFactory(){
        ...
        factory.setBatchListener(kafkaConsumerConfigData.getBachLister());
